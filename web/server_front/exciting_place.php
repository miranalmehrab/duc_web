...
<script>
	document.title = "Exciting places";
</script>
...
<div class = "container-fluid">
	...
	<tbody>
		<?php
			$query = "select * from exciting_place";
...
<div class="container-fluid">
	<form  class="form-inline" action="../server_back/exciting_place/insert_place.php" method="post">
...
<div class="container-fluid">
	<form class="form-inline" action="../server_back/exciting_place/update_place.php" method="post">
...
<div class = "container-fluid">
	<form class="form-inline" action="../server_back/exciting_place/delete_place.php" method="post">
