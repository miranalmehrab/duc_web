...
<script>
	document.title = "History of Dhaka University";
</script>
...
<div class = "container-fluid">
	...
	<tbody>
		<?php
			$query = "select * from history_of_du";
...
<div class="container-fluid">
	<form  class="form-inline" action="../server_back/history_of_du/insert_history.php" method="post">
...
<div class="container-fluid">
	<form class="form-inline" action="../server_back/history_of_du/update_history.php" method="post">
...
<div class = "container-fluid">
	<form class="form-inline" action="../server_back/history_of_du/delete_history.php" method="post">
	
	<input type="text" name="id" placeholder="Enter ID">
	&nbsp;
	<input type="hidden" name="table_name" value="faculty_of_sciences">
