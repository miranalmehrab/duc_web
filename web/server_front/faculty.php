...
<script>
	document.title = "Faculty of Dhaka University";
</script>
...
<div class = "container-fluid">
	...
	<tbody>
		<?php
			$query = "select * from faculty_of_du";
...
<div class="container-fluid">
	<form  class="form-inline" action="../server_back/faculty/insert_faculty.php" method="post">
...
<div class="container-fluid">
	<form class="form-inline" action="../server_back/faculty/update_faculty.php" method="post">
...
<div class = "container-fluid">
	<form class="form-inline" action="../server_back/faculty/delete_faculty.php" method="post">
