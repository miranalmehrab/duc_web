...
<script>
	document.title = "Faculty of Business Studies";
</script>
...
<div class = "container-fluid">
	...
	<tbody>
		<?php
			$query = "select * from faculty_of_business_studies";
...
<!--	<input type="text" name="description" placeholder="Enter Description"> &nbsp; -->
	...
	<input type="hidden" name="table_name" value="faculty_of_business_studies"> 
