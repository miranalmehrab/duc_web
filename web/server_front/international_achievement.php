...
<script>
	document.title = "Achievements at national and international level";
</script>
...
<div class = "container-fluid">
	...
	<tbody align="center">
		<?php
			$query = "select * from international_achievement";
...
<div class="container-fluid">
	<form  class="form-inline" action="../server_back/international_achievement/insert_international_achievement.php" method="post">
...
<div class="container-fluid">
	<form class="form-inline" action="../server_back/international_achievement/update_international_achievement.php" method="post">
...
<div class = "container-fluid">
	<form class="form-inline" action="../server_back/international_achievement/delete_international_achievement.php" method="post">
