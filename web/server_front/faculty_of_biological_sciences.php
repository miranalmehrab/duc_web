...
<script>
	document.title = "Faculty of Biological Sciences";
</script>
...
<div class = "container-fluid">
	...
	<tbody>
		<?php
			$query = "select * from faculty_of_biological_sciences";
...
<!--	<input type="text" name="description" placeholder="Enter Description"> &nbsp; -->
	...
	<input type="hidden" name="table_name" value="faculty_of_biological_sciences"> 
