...
<div class="container-fluid">
	<form  class="form-inline" action="../server_back/office/insert_office.php" method="post">
...
<div class="container-fluid">
	<form class="form-inline" action="../server_back/office/update_office.php" method="post">
...
<div class = "container-fluid">
	<form class="form-inline" action="../server_back/office/delete_office.php" method="post">
